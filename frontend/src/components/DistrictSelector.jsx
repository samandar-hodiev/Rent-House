  ...
  return (
    ...
    >
      <button
        ...
        className="flex h-full items-center gap-1.5 px-3 py-2 text-sm text-text-secondary hover:bg-surface-secondary focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
      >
